...
impl Event {
    /// Makes a new singular event with exact date, description, and category.
    ...
    /// Makes a new annual event with month-day, description, and category.
    ...
    /// Makes a new rule-based event with a rule, description, and category.
